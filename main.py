...
session_state = st.sessionstate.get(page_name='Home')
st.set_page_config(
    page_title="Hello",
    page_icon="👋",
)
...
- Analyze the Udacity Self-driving Car Image Dataset using a neural network: [demo-self-driving](https://github.com/streamlit/demo-self-driving)
- Explore a New York City rideshare dataset: [demo-uber-nyc-pickups](https://github.com/streamlit/demo-uber-nyc-pickups)
